...
- `/admin` - Agents admin, including Agents, Runs, and Usage by agent. Agent names open a details page. The actions menu on Agents turns an agent on or off. Skills and tools on that page open their own details.
