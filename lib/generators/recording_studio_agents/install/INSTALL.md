...
5. Register skills, knowledge, skill packs, and agents, then call Agent#run from a controller or job. Required skills always compile. Pass pack: or extra_skills: only when a ticket needs optional skills.
